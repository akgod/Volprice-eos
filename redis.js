...
//const url = `redis://172.31.212.143:6379`;
const url = `redis://127.0.0.1:6379`;
const client = redis.createClient({ url , password:"marskiller"}); 
//const client = redis.createClient({ host: "172.31.212.131", port: 6379 , password:"marskiller"}); 
...
class database {
    ...
    async set(key,value){   // 存储一个 key value
        await client.set(key, value);  //string,string  
    }
